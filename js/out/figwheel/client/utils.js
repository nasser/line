...
return (new CustomEvent(event_name,(function (){var obj54887 = {"detail":data};
return obj54887;
})()));
} else {
...
var f = (function (){var pred__54894 = cljs.core._EQ_;
var expr__54895 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__54894.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__54895))){
return ((function (pred__54894,expr__54895){
return (function (p1__54888_SHARP_){
return console.warn(p1__54888_SHARP_);
});
;})(pred__54894,expr__54895))
} else {
if(cljs.core.truth_(pred__54894.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__54895))){
return ((function (pred__54894,expr__54895){
return (function (p1__54889_SHARP_){
return console.debug(p1__54889_SHARP_);
});
;})(pred__54894,expr__54895))
} else {
if(cljs.core.truth_(pred__54894.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__54895))){
return ((function (pred__54894,expr__54895){
return (function (p1__54890_SHARP_){
return console.error(p1__54890_SHARP_);
});
;})(pred__54894,expr__54895))
} else {
return ((function (pred__54894,expr__54895){
return (function (p1__54891_SHARP_){
return console.log(p1__54891_SHARP_);
});
;})(pred__54894,expr__54895))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__54898){
var map__54899 = p__54898;
var map__54899__$1 = ((((!((map__54899 == null)))?((((map__54899.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54899.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54899):map__54899);
var opts = map__54899__$1;
var eval_fn = cljs.core.get.call(null,map__54899__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__54901_SHARP_);
});})(new_def))
);
...
var vec__54903 = p__54902;
var ky = cljs.core.nth.call(null,vec__54903,(0),null);
var v = cljs.core.nth.call(null,vec__54903,(1),null);
...
}catch (e54908){if((e54908 instanceof Error)){
var e = e54908;
return not_found;
} else {
throw e54908;
...
//# sourceMappingURL=utils.js.map?rel=1509236545858

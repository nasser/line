...
var reader = (function (){var or__7645__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__7645__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__7645__auto__)){
return or__7645__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__12604__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12604__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12604__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12603){var _e = e12603;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___12606 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___12606)){
var seen_errors_12607 = temp__4655__auto___12606;
if(cljs.core.truth_(seen_errors_12607.has(self))){
} else {
seen_errors_12607.add(self);

var temp__4657__auto___12608 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___12608)){
var sense_12609 = temp__4657__auto___12608;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12609)].join('');
} else {
}
}
} else {

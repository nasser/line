...
var len__8814__auto___10265 = arguments.length;
var i__8815__auto___10266 = (0);
while(true){
if((i__8815__auto___10266 < len__8814__auto___10265)){
args__8821__auto__.push((arguments[i__8815__auto___10266]));

var G__10267 = (i__8815__auto___10266 + (1));
i__8815__auto___10266 = G__10267;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8822__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq10263){
var G__10264 = cljs.core.first.call(null,seq10263);
var seq10263__$1 = cljs.core.next.call(null,seq10263);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__10264,seq10263__$1);
});
...
return (p1__10268_SHARP_ === object);
});})(history))
,history);
});

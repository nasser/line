...
var G__10245 = devtools.prefs.pref.call(null,v);
v = G__10245;
continue;
} else {
return v;
...
var and__7633__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7633__auto__){
var and__7633__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7645__auto__ = (function (){try{if(!((value == null))){
...
}catch (e10248){var _e__9265__auto__ = e10248;
return false;
}})();
if(cljs.core.truth_(or__7645__auto__)){
return or__7645__auto__;
} else {
var or__7645__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e10252){var _e__9265__auto__ = e10252;
return false;
}})();
...
}catch (e10254){var _e__9265__auto__ = e10254;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7633__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7633__auto__)){
var and__7633__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7633__auto____$1){
...
var and__7633__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7633__auto__)){
...
var or__7645__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7645__auto__)){
return or__7645__auto__;
} else {
...
var and__7633__auto__ = (function (){var or__7645__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7645__auto__)){
return or__7645__auto__;
} else {
...
var vec__10256 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10256,(0),null);
var name = cljs.core.nth.call(null,vec__10256,(1),null);
...
var and__7633__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7633__auto__)){
...
var or__7645__auto__ = typeof value === 'string';
if(or__7645__auto__){
return or__7645__auto__;
} else {
var or__7645__auto____$1 = typeof value === 'number';
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10259_SHARP_);
}),template);
});

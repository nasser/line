...
var len__8814__auto___10274 = arguments.length;
var i__8815__auto___10275 = (0);
while(true){
if((i__8815__auto___10275 < len__8814__auto___10274)){
args__8821__auto__.push((arguments[i__8815__auto___10275]));

var G__10276 = (i__8815__auto___10275 + (1));
i__8815__auto___10275 = G__10276;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8822__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10271){
var G__10272 = cljs.core.first.call(null,seq10271);
var seq10271__$1 = cljs.core.next.call(null,seq10271);
var G__10273 = cljs.core.first.call(null,seq10271__$1);
var seq10271__$2 = cljs.core.next.call(null,seq10271__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__10272,G__10273,seq10271__$2);
});
...
if(cljs.core.truth_((function (){var or__7645__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8270__auto__,writer__8271__auto__,opt__8272__auto__){
return cljs.core._write.call(null,writer__8271__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7633__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7633__auto__){
var or__7645__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7645__auto__)){
return or__7645__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10277_SHARP_){
return !((cljs.core.meta.call(null,p1__10277_SHARP_) == null));
})))){
...
var map__10278 = opts;
var map__10278__$1 = ((((!((map__10278 == null)))?((((map__10278.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10278.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10278):map__10278);
var markup_db = cljs.core.get.call(null,map__10278__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7645__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e10282){var _e__9265__auto__ = e10282;
return false;
}})();
if(cljs.core.truth_(or__7645__auto__)){
return or__7645__auto__;
...
}catch (e10284){var _e__9265__auto__ = e10284;
return false;
}}
})())){
...
var _STAR_current_state_STAR_10286 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__10287 = opts;
...
var markup_db = cljs.core.get.call(null,map__10287__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_10286;
}});
...
;
var temp__4655__auto___10291 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___10291)){
var managed_print_level_10292 = temp__4655__auto___10291;
var _STAR_print_level_STAR_10290_10293 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_10292;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_10290_10293,managed_print_level_10292,temp__4655__auto___10291,writer,opts,job_fn){
return (function (p1__10289_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10289_SHARP_,null);
});})(_STAR_print_level_STAR_10290_10293,managed_print_level_10292,temp__4655__auto___10291,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_10290_10293;
}} else {
job_fn.call(null);
}

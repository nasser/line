...
var G__12279 = o;
(G__12279[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12285 = jsprops;
(G__12285["defaultValue"] = value);

(G__12285["onChange"] = ((function (G__12285,v,value,on_change){
return (function (p1__12284_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12284_SHARP_);
});})(G__12285,v,value,on_change))
);
...
var vec__12288 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12288,(0),null);
var id = cljs.core.nth.call(null,vec__12288,(1),null);
var class$ = cljs.core.nth.call(null,vec__12288,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12292 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___12292 == null)){
} else {
var key_12293 = temp__4661__auto___12292;
(jsprops["key"] = key_12293);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12294 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__12294["name"] = c);
...
var len__8814__auto___12299 = arguments.length;
var i__8815__auto___12300 = (0);
while(true){
if((i__8815__auto___12300 < len__8814__auto___12299)){
args__8821__auto__.push((arguments[i__8815__auto___12300]));

var G__12301 = (i__8815__auto___12300 + (1));
i__8815__auto___12300 = G__12301;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12297){
var G__12298 = cljs.core.first.call(null,seq12297);
var seq12297__$1 = cljs.core.next.call(null,seq12297);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12298,seq12297__$1);
});
...
break;
default:
var G__12304 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12304;
continue;
...
var n__8590__auto___12306 = a.length;
var i_12307 = (0);
while(true){
if((i_12307 < n__8590__auto___12306)){
(a[i_12307] = reagent.impl.template.as_element.call(null,(a[i_12307])));

var G__12308 = (i_12307 + (1));
i_12307 = G__12308;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__8590__auto___12309 = a.length;
var i_12310 = (0);
while(true){
if((i_12310 < n__8590__auto___12309)){
var val_12311 = (a[i_12310]);
if((cljs.core.vector_QMARK_.call(null,val_12311)) && ((reagent.impl.template.key_from_vec.call(null,val_12311) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12310] = reagent.impl.template.as_element.call(null,val_12311));
...
var ctx = ({});
var vec__12313 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12313,(0),null);
var derefed = cljs.core.nth.call(null,vec__12313,(1),null);
...
var G__12316 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12316) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12316){

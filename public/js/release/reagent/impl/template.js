...
var G__13553 = o;
(G__13553[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__13555__i < G__13555__a.length) {G__13555__a[G__13555__i] = arguments[G__13555__i + 0]; ++G__13555__i;}
  args = new cljs.core.IndexedSeq(G__13555__a,0,null);
} 
...
var G__13559 = jsprops;
(G__13559["defaultValue"] = value);

(G__13559["onChange"] = ((function (G__13559,v,value,on_change){
return (function (p1__13558_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13558_SHARP_);
});})(G__13559,v,value,on_change))
);
...
var vec__13562 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13562,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13562,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13562,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13566 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13566 == null)){
} else {
var key_13567 = temp__4661__auto___13566;
(jsprops["key"] = key_13567);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13568 = reagent.impl.template.__GT_NativeWrapper();
(G__13568["name"] = c);
...
var G__13569 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13569) : reagent.impl.template.as_element.call(null,G__13569));
} else {
...
var len__8814__auto___13574 = arguments.length;
var i__8815__auto___13575 = (0);
while(true){
if((i__8815__auto___13575 < len__8814__auto___13574)){
args__8821__auto__.push((arguments[i__8815__auto___13575]));

var G__13576 = (i__8815__auto___13575 + (1));
i__8815__auto___13575 = G__13576;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13572){
var G__13573 = cljs.core.first(seq13572);
var seq13572__$1 = cljs.core.next(seq13572);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13573,seq13572__$1);
});
...
break;
default:
var G__13579 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13579;
continue;
...
var n__8590__auto___13581 = a.length;
var i_13582 = (0);
while(true){
if((i_13582 < n__8590__auto___13581)){
(a[i_13582] = reagent.impl.template.as_element((a[i_13582])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8590__auto___13584 = a.length;
var i_13585 = (0);
while(true){
if((i_13585 < n__8590__auto___13584)){
var val_13586 = (a[i_13585]);
if((cljs.core.vector_QMARK_(val_13586)) && ((reagent.impl.template.key_from_vec(val_13586) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13585] = reagent.impl.template.as_element(val_13586));
...
var ctx = ({});
var vec__13588 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13588,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13588,(1),null);
...
var G__13591 = (cljs.core.count(argv) - first_child);
switch (G__13591) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13591){
